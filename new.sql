...
INSERT INTO ANIMALS(animals, region, animals_info)
VALUES("видра","Витоша","Разпространение и численост в България: Среща се в равнините, по морското крайбрежие и в планините – до 600 m най - често. Численост (без малките) около 1300–1500 индивида, към 2007 г. Най-плътна е популацията в Югоизточна България.
...
INSERT INTO ANIMALS(animals, region, animals_info)
VALUES("вълк","Витоша","Разпространение и численост в България: През 1996–1999 г. – поне 1000 индивида. Сега намаляват, численост 700–800 индивида. През размножителния период обитава планините, частично Североизточна България. Есента и до средата на зимата слиза и в равнините.
...
INSERT INTO ANIMALS(animals, region, animals_info)
VALUES("дива коза","Витоша","Разпространение и численост в България: до 2005 г. нарастват на 1600–1800 индивида. Централен Балкан – 200–220 индивида, Рила – 450–500, Пирин – 200, Западни Родопи – 750–850.
...
INSERT INTO ANIMALS(animals, region, animals_info)
VALUES("лалугер","Витоша","Разпространение и численост в България: Среща се в цялата страна, в планините до 2500 m. Съвременните данни показват съществен спад в числеността и/или намаляване на заселената площ и изчезването му в отделни локалитети.
...
INSERT INTO ANIMALS(animals, region, animals_info)
VALUES("малък ястреб","Витоша","Разпространение и численост в България: Постоянен и преминаващ вид. През гнездовия период се среща почти в цялата страна; с най-висока численост в планините и предпланините (Стара планина, Пирин, Славянка, Витоша) и Черноморското крайбрежие. Числеността на гнездещата популация в България нараства – под 1000 двойки, а на зимуващата – 2000–5000 птици.
...
INSERT INTO PLANTS(plants, region, plants_info)
VALUES("Обикновена хвойна","Витоша","Обикновената хвойна, наричана още синя хвойна, е вид иглолистно растение от семейство Кипарисови.
