...
SELECT REGIONS.region_ID
FROM REGIONS
INNER JOIN PLANTS ON REGIONS.region_ID = PLANTS.region_ID

SELECT ANIMALS.animals, ANIMALS.animals_info, ANIMALS.region_ID, REGIONS.region_name 
FROM ANIMALS 
INNER JOIN REGIONS ON ANIMALS.region_ID = REGIONS.region_ID

SELECT PLANTS.plants, PLANTS.plants_info, PLANTS.region_ID, REGIONS.region_name 
FROM PLANTS 
INNER JOIN REGIONS ON PLANTS.region_ID = REGIONS.region_ID