...
INSERT INTO Sofia_region(animals,animals_info,plants,plants_info)
VALUES("дива коза","Разпространение и численост в България: до 2005 г. нарастват на 1600–1800 индивида. Централен Балкан – 200–220 индивида, Рила – 450–500, Пирин – 200, Западни Родопи – 750–850.
...
Необходими мерки за опазване: Спешно проучване на генофонда на подвида и последиците от хибридизацията. Взимане на мерки за ограничаването й. Изготвяне на международна план за опазване на подвида. Включване на подвида в Червения списък на IUCN.","обикновена пърчковка","Многогодишно тревисто растение с 2 яйцевидни грудки. Стъблата високи 30–90 cm, с 5–8 сиво-зелени, елиптични листа. Съцветията с 20–40 цвята, рехави. Околоцветните листчета събрани в шлем, виолетово-бели с надлъжни линии. Устната 3-делна; страничните дялове линейни, извити, дълги 9–22 mm, вълнисти по края; средният дял дълъг 4,5–8,5 cm, леко усукан, на върха 2-делен.  Насекомоопрашващо се растение. Размножава се със семена.
...
INSERT INTO Sofia_region(animals,animals_info,plants,plants_info)
VALUES("лалугер","Разпространение и численост в България: Среща се в цялата страна, в планините до 2500 m. Съвременните данни показват съществен спад в числеността и/или намаляване на заселената площ и изчезването му в отделни локалитети.
...
Необходими мерки за опазване: Подробно картиране на разпространението, изясняване на вътревидовата структура и оценка на състоянието на числеността на локалните популации и местообитанията им. Ефективно прилагане на ЗБР за приоритетно опазване на местообитанията му чрез разработване на регионални Планове за управление в контекста на програмите за развитие на селските райони и в частност прилагането на традиционните практики за пасищно скотовъдство.","Имануелова метличина","Иманеуловата метличина е многогодишно тревисто растение, расте по сухи каменисти места и сипеи, с южно или югозападно изложение, върху кисела основна скала
В България се намира в Знеполския район (Конявска планина, Голо бърдо), Струмската долина (Бобошевски Руен, Сандански, Кресна, с. Ощава) и планина Пирин; 100–900 m надморска височина.
Тя е защитен вид съгласно Закона за биологично разнообразие. 
Направено е предложение за обявяване на защитена местност във Виденския дял на Конявска планина. 
...
INSERT INTO Sofia_region(animals,animals_info,plants,plants_info)
VALUES("малък ястреб","Разпространение и численост в България: Постоянен и преминаващ вид. През гнездовия период се среща почти в цялата страна; с най-висока численост в планините и предпланините (Стара планина, Пирин, Славянка, Витоша) и Черноморското крайбрежие. Числеността на гнездещата популация в България нараства – под 1000 двойки, а на зимуващата – 2000–5000 птици.
...
Необходими мерки за опазване: Намаляване на безпокойството (например забрана на дърводобива през гнездовия сезон в райони в съседство с гнездови находища), засилване контрола срещу бракониерството, охраняване на отделни гнезда през размножителния сезон. Включване на повече гнездови находища (главно край туристическите маршрути и екопътеките) в пределите на защитени територии.","Карпатска тоция","Карпатската тоция е полупаразитно многогодишно тревисто растение. Расте по мочурливи места и брегове на потоци. Образува силно фрагментирани, обикновено малочислени популации.
В България се среща в Стара планина (Зап., Ср.), Витошкия район (Витоша), Пирин, Рила, Родопите (Зап.); от 1200 до около 2500 m надморска височина.
Тя е защитен вид, местообитанията на който се нуждаят от приоритетна защита съгласно Закона за биологичното разнообразие. 
Част от находищата попадат в границите на защитени територии – природен парк „Витоша“, националните паркове „Рила“ и „Пирин“ и в защитени зони от Европейската екологична мрежа НАТУРА 2000 в България.
Необходимите мерки за защита са: Разработване на План за действие за опазване вида. Детайлно проучване на числеността и площта на популациите, на биологията и екологията на вида и на застрашаващите фактори. Мониторинг на състоянието на избрани популации.");
